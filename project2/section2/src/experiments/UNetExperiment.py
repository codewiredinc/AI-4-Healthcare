...
class UNetExperiment:
    ...
    def __init__(self, config, split, dataset):
        ...
        # a tensor with softmax prediction of each pixel's probability of belonging 
        # to a certain class
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # We are also getting softmax version of prediction to output a probability map
